...
- Backup EPI2ME instance data (first-level files only)
...
| Nextflow parameter name  | Type | Description | Help | Default |
|-------------------------|------|-------------|------|---------|
| epi2me_data | string | Path to EPI2ME instance folder. | Path to EPI2ME instance folder. Only first-level files will be copied (no subdirectories). |  |
